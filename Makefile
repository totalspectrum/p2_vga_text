...
vgatile.zip: README.txt $(FONTS) makebitmap.c vga.map vga640x480.spin2 vga800x600.spin2 vga_tile_driver.spin2 vga_text_routines.spinh std_text_routines.spinh picture.ans
	rm -rf vgatile.zip
	zip -r vgatile.zip $^
