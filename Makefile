...
CDRIVER=ccode/vgatext.c ccode/vgatext.h ccode/vga_tile_driver.c ccode/vga_tile_driver.h

DRIVERS=vgatext_640x480.spin2 vgatext_800x600.spin2 vgatext_1024x768.spin2 vga_tile_driver.spin2 vga_text_routines.spinh std_text_routines.spinh $(CDRIVER)
